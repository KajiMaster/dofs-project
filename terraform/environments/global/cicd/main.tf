...
variable "terraform_state_bucket" {
  ...
  description = "S3 bucket for Terraform state (used by pipeline)"
}
...
# CodeBuild role for prod pipeline (more restrictive)
...
# Outputs
output "nonprod_pipeline_url" {
  value       = "https://console.aws.amazon.com/codesuite/codepipeline/pipelines/${aws_codepipeline.nonprod.name}/view"
  description = "URL to non-prod pipeline in AWS Console"
}

output "prod_pipeline_url" {
  value       = "https://console.aws.amazon.com/codesuite/codepipeline/pipelines/${aws_codepipeline.prod.name}/view"
  description = "URL to prod pipeline in AWS Console"
}
